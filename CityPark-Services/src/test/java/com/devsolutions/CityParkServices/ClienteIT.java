...
public class ClienteIT {
    ...
    public void criarCliente_ComDadosValidos_RetornarClienteComStatus201() {
        ClienteResponseDto responseBody = testClient
                ...
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "figueiredomaster@email.com", "123456"))
                .bodyValue(new ClienteCreateDto("Figueiredo Master", "26753289011"))
                .exchange()
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getNome()).isEqualTo("Figueiredo Master");
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("26753289011");
    ...
    public void criarCliente_ComCpfJaCadastrado_RetornarErrorMessageStatus409() {
        ErrorMessage responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "figueiredomaster@email.com", "123456"))
                .bodyValue(new ClienteCreateDto("Figueiredo Master", "59644826000"))
                .exchange()
    ...
    public void criarCliente_ComDadosInvalidos_RetornarErrorMessageStatus422() {
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "figueiredomaster@email.com", "123456"))
                .bodyValue(new ClienteCreateDto("Fig", "11111111111"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "figueiredomaster@email.com", "123456"))
                .bodyValue(new ClienteCreateDto("Fig", "267.532.890-11"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void buscarCliente_ComDadosDoTokenDeCliente_RetornarClienteComStatus200() {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("94392380033");
        org.assertj.core.api.Assertions.assertThat(responseBody.getNome()).isEqualTo("Star Master");
        org.assertj.core.api.Assertions.assertThat(responseBody.getId()).isEqualTo(10);
